			...
			if ( ! empty( $service ) ) {
				foreach ( $service as $key => $value ) {
					...
					if ( isset( $key ) && $key == 'bp_share_whatsapp' && $value[ 'chb_' . $key ] == 1 ) {
						echo '<a target="blank" class="bp-share" href="https://web.whatsapp.com/send?text=' . $activity_link . '&image_sharer=1" data-action="share/whatsapp/share" rel="whatsapp"><span class="fa-stack fa-lg"><i class="' . $value['service_icon'] . '"></i></span></a>';
					}
				}
			} else {

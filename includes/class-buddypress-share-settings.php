...
class Buddypress_Share_Options_Page {
	...
	public function bp_share_settings_init() {
		...
		add_settings_field(
			'bp_share_avatar_open_graph',
			esc_html__( 'Use avatar as open graph image', 'buddypress-share' ),
			array( $this, 'bp_share_checkbox_avatar_opengraph_render' ),
			'bp_share_services_extra',
			'bp_share_extra_options'
		);
	}
	...
	public function bp_share_checkbox_open_services_render() {
		...
		<?php
		if ( $extra_options['bp_share_services_open'] == 1 ) {
	...
	public function bp_share_checkbox_avatar_opengraph_render() {
		...
		?>
		<input type='checkbox' name='bp_share_avatar_open_graph'
		<?php
		if ( $avatar_enable == 1 ) {
			echo 'checked="checked"'; }
		?>
								...
								foreach ( $social_options as $service_key => $social_option ) {
									...
									<tr class="bp-share-services-row" id="<?php echo 'tr_' . $service_key; ?>">
										<th scope="row" id="bp_share_chb" class="bp-share-td">
											<input type="checkbox" name="<?php echo 'chb_' . $service_key; ?>" value="1"
																					<?php

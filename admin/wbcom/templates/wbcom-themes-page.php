<div class="wrap">
	...
	<div class="reign-demos-wrapper">
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'Reign BuddyPress', 'buddypress-share' ); ?></h4>
		...
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'LearnMate', 'buddypress-share' ); ?></h4>
		<div class="wbcom-demo-content-wrap">
			<div class="wbcom-demo-importer">
				<div class="container">
					<div class="wbcom-image-wrapper">
		...
		<h4 class="wbcom-demo-name"><?php esc_html_e( 'StoreMate', 'buddypress-share' ); ?></h4>
		<div class="wbcom-demo-content-wrap">
			<div class="wbcom-demo-importer">
				<div class="container">
					<div class="wbcom-image-wrapper">

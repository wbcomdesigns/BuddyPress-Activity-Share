			...
			<div class="notice updated buddypress-share-notice">
				<div class="buddypress-share-notice-inner">
					<div class="buddypress-share-notice-icon">
						<img src="<?php echo BP_ACTIVITY_SHARE_PLUGIN_URL . 'admin/images/bp_social_share.png'; ?>" alt="<?php echo esc_attr__( 'BuddyPress Activity Social Share', 'buddypress-share' ); ?>" />
					</div>
